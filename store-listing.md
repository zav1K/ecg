...
**Короткий опис (80):**
Живий ЕКГ-монітор: 28 станів, аритмії, STEMI, іспит-режим. Українською.
...
**Що всередині:**
✓ 28 станів і ритмів — від норми до STEMI та постінфарктних Q-хвильових змін за локалізаціями, фібриляції передсердь, повної АВ-блокади, WPW, гіперкаліємії, кардіостимуляції
...
18 з 28 станів і базовий режим іспиту — безкоштовно назавжди. Спеціалізований пак (рідкісні локалізації STEMI/старого ІМ, усі режими кардіостимуляції, повний банк питань іспиту, експорт стрічки) — одноразова покупка, без підписки.
...
Live ECG monitor: 28 states, arrhythmias, STEMI, exam mode. Free to start.
...
**What's inside:**
✓ 28 rhythms and conditions — from normal sinus rhythm to STEMI and post-infarction Q-wave changes by location, atrial fibrillation, complete AV block, WPW, hyperkalemia, and pacemaker rhythms
...
18 of 28 states and basic exam mode are free forever. The specialist pack (rare STEMI/old-MI locations, all pacemaker modes, the full exam question bank, and strip export) is a one-time purchase — no subscription.
